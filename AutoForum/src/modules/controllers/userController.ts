...
const updatePassword = (request: http.IncomingMessage, response: http.ServerResponse, username: string) => {
...
const deleteUser = (request: http.IncomingMessage, response: http.ServerResponse, username: string) => {
    getPostData(request).then(body => {
